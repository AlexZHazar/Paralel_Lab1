...
1. **Автоматизация экспериментов**  
   Программа теперь сама перебирает размеры матриц (200, 400, …, 3600) и сохраняет время в `timings.txt`.
...
![Фрагмент работы скрипта верификации](ver.png)
...
![График времени](изображение_2026-03-02_031037172.png)  
